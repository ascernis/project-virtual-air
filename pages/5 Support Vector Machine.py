...
# Loads Support Vector Machine (SVM) Model with probability estimates
svmModel = joblib.load("./models/svm_CO_model.joblib")
...
# Prediction Function
prediction = svmModel.predict([[WindDirection, Station, PM2_5, SO2, NO2, O3, Temperature, Pressure, DewPoint, Rain, WindSpeed]])

# Probability Estimates
prediction_proba = svmModel.predict_proba([[WindDirection, Station, PM2_5, SO2, NO2, O3, Temperature, Pressure, DewPoint, Rain, WindSpeed]])

# Display Prediction
st.write(f"Prediction: {prediction}")

# Display Probability Estimates
